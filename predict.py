...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        weights_path = "result/result_cu1/group{}/exp0{}/model.pth".format(group_index, i + 1)
        con_matrix_path = "result/result_cu1/group{}/exp0{}/confusion_matrix.txt".format(group_index, i + 1)
        acc_path = "result/result_cu1/group{}/exp0{}/test_result.txt".format(group_index, i + 1)
        tsne_save_path = "result/result_cu1/group{}/exp0{}/".format(group_index, i + 1)
        prediction(weights_path, con_matrix_path, acc_path, tsne_save_path)