...
def makeSample(paths):
    ...
    csv_pd.to_csv(r'./data1/train/train.csv', sep=',',
                  header=False, index=False)
    csv_pd = pd.DataFrame(val_datas)
    csv_pd.to_csv(r'./data1/val/val.csv', sep=',',
                  header=False, index=False)
    csv_pd = pd.DataFrame(test_datas)
    csv_pd.to_csv(r'./data1/test/test.csv', sep=',',
                  header=False, index=False)
...
if __name__ == '__main__':
    ...
    path.append(r'./data/Original/0HP/normal_0_97.mat')
    path.append(r'./data/Original/0HP/12k_Drive_End_B007_0_118.mat')
    path.append(r'./data/Original/0HP/12k_Drive_End_B014_0_185.mat')
    path.append(r'./data/Original/0HP/12k_Drive_End_B021_0_222.mat')
    path.append(r'./data/Original/0HP/12k_Drive_End_IR007_0_105.mat')
    path.append(r'./data/Original/0HP/12k_Drive_End_IR014_0_169.mat')
    path.append(r'./data/Original/0HP/12k_Drive_End_IR021_0_209.mat')
    path.append(r'./data/Original/0HP/12k_Drive_End_OR007@6_0_130.mat')
    path.append(r'./data/Original/0HP/12k_Drive_End_OR014@6_0_197.mat')
    path.append(r'./data/Original/0HP/12k_Drive_End_OR021@6_0_234.mat')
    makeSample(path)
