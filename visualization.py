...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        # txt_path = 'result/result_cu1/group{}/exp0{}/confusion_matrix.txt'.format(group_index, i + 1)
        # jpg_path = 'result/result_cu1/group{}/exp0{}/confusion_matrix.jpg'.format(group_index, i + 1)
        # confusion_matrix(txt_path, jpg_path)
    ...
    estimate_path = 'result/result_cu1/group{}'.format(group_index)
