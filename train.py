...
def train(model_save_path, train_result_path, val_result_path, hp_save_path, epochs=100):
    ...
    #加载数据
    train_path = r'./data1/train/train.csv'
    val_path = r'./data1/val/val.csv'
    ...
    #定义模型
    model = DSCTransformer(input_dim=input_dim, num_classes=7, dim=d_model, depth=N,
...
if __name__ == '__main__':
    group_index = 4
    for i in range(5):
        model_save_path = "result/result_cu1/group{}/exp0{}/model.pth".format(group_index, i+1)
        hp_save_path = "result/result_cu1/group{}/parameters.txt".format(group_index)
        train_result_path = "result/result_cu1/group{}/exp0{}/train_result.txt".format(group_index, i+1)
        val_result_path = "result/result_cu1/group{}/exp0{}/val_result.txt".format(group_index, i+1)
